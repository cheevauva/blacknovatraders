        ...
        <div class="col">
            <?php if (empty($self->links)) : ?>
                <div class="alert alert-info">
                    <?php echo $l->l_warp_nolink; ?>
                </div>
            <?php else : ?>
                <div class="mb-3">
                    <?php echo $l->l_warp_linkto; ?>
                </div>
                <div class="mb-3">
    ...
    <div class="row">
        <div class="col">
            <form action="<?= route('warpedit'); ?>" method="POST" id="bntWarpeditLink">
                ...
                <div class="mb-3">
                    <label class="form-label"><?php echo $l->l_warp_query; ?></label>
        ...
        <div class="col">
            <form action="<?= route('warpedit'); ?>" method="POST" id="bntWarpeditUnlink">
                ...
                <div class="mb-3">
                    <label class="form-label"><?php echo $l->l_warp_destquery; ?></label>
