...
<form action="<?= route('preset'); ?>" method="POST" class="preset-form" id="bntPresetForm">
    ...
    <button type="submit" class="btn btn-primary"><?php echo $l->pre_save; ?></button>
