...
$l_planet_logout     = "Vous pouvez aussi <a href=[logout]>Quitter</a> le jeu sous la protection de votre planète.";
...
$l_die_please        = "S'il vous plaît, <A HREF=[logout]>Quittez</A>";
...
$l_log_months = array('Janvier','Février','Mars','Avril','Mai','Juin','Juillet','Août','Septembre','Octobre','Novembre','Décembre');
$l_log_months_short = array('Jan','Fév','Mar','Avr','Mai','Jun','Jui','Au','Sep','Oct','Nov','Déc');
...
$l_log_click = "Cliquez <A HREF=$interface><font color=#00ff00>ici</font></A> pour retourner au menu principal.";
$l_log_note = "NOTE: Si cette page ne s'affiche pas correctement, ou si vous n'aimez pas les effets de HTML dynamique ou vous les trouvez agaçants, vous pouvez les désactiver <a href=[options]><font color=#00FF00>ici</font>";

$l_log_text[LogTypeConstants::LOG_LOGIN] = "Vous vous êtes connecté, à partir de [ip].";
$l_log_title[LogTypeConstants::LOG_LOGIN] = "Connection";
$l_log_text[LogTypeConstants::LOG_LOGOUT] = "Vous vous êtes déconnecté, à partir de [ip].";
$l_log_title[LogTypeConstants::LOG_LOGOUT] = "Déconnection";
$l_log_text[LogTypeConstants::LOG_ATTACK_OUTMAN] = "[player] a été ciblé sur un vecteur d'attaque, mais votre grand talent de pilote et vos moteurs supérieurs vous ont permis d'éviter l'ennemi.";
$l_log_title[LogTypeConstants::LOG_ATTACK_OUTMAN] = "Esquive!";
$l_log_text[LogTypeConstants::LOG_ATTACK_OUTSCAN] = "Vous avez détecté les armes de [player] qui essayaient de se verrouiller sur votre vaisseau, mais vos générateurs de camouflage vous ont permis de tromper l'armement primitif de votre ennemi.";
$l_log_title[LogTypeConstants::LOG_ATTACK_OUTSCAN] = "Camouflage!";
$l_log_text[LogTypeConstants::LOG_ATTACK_EWD] = "Vous êtes surpris par l'attaque en traitre de [player]. Vous pouvez apercevoir les missiles qui se dirigent vers vous pendant que vous courez vers le bouton d'hyper-espace d'urgence. L'univers se brouille autour de vous et, pour une milli-seconde, vous croyez que vous êtes mort. Quand vous ouvrez finallement les yeux, vous vous apercevez que vous avez été transporté dans un endroit plus sûr. Mais où est cet endroit, vous ne le savez pas...";
$l_log_title[LogTypeConstants::LOG_ATTACK_EWD] = "Hyper-espace d'urgence!";
$l_log_text[LogTypeConstants::LOG_ATTACK_EWDFAIL] = "Vos détecteurs se fixent sur le vaisseau de [player], qui est sur un vecteur d'attaque. \"Mieux vaut prévenir que guérir\", vous pensez, appuyant sur le bouton d'hyper-espace d'urgence. Vous entendez un son étrange d'étouffement venant de la salle des moteurs et vous sentez des circuits brûlés. \"Stupide boîte de conserve!\", vous criez, en donnant un coup de pied à l'ordinateur. Il émet des bips de protestation pendant que vous vous préparez pour le combat...";
$l_log_title[LogTypeConstants::LOG_ATTACK_EWDFAIL] = "Hyper-espace d'urgence <font color=red>en panne!</font>";
$l_log_text[LogTypeConstants::LOG_ATTACK_LOSE] = "Votre vaisseau est attaqué par [player]. Vous faites de votre mieux, mais vous ne pouvez vous défendre contre l'armement supérieur de [player]. Votre vaisseau a été détruit. ";
$l_log_title[LogTypeConstants::LOG_ATTACK_LOSE] = "<font color=red>Combat perdu!</font>";
$l_log_text[LogTypeConstants::LOG_ATTACKED_WIN] = "Votre vaisseau a été attaqué par [player]. Vous vous battez un moment, puis le combat cesse. Vous perdez [armor] points d'armure et [fighters] intercepteurs dans l'escarmouche.";
$l_log_title[LogTypeConstants::LOG_ATTACKED_WIN] = "<font color=yellow>Escarmouche!</font>";
$l_log_text[LogTypeConstants::LOG_TOLL_PAID] = "Vous avez dû payer [toll] crédits pour entrer dans le secteur [sector]. Vous vous promettez bien de trouvez un moyen de récupérer votre argent.";
$l_log_title[LogTypeConstants::LOG_TOLL_PAID] = "Extortion";
$l_log_text[LogTypeConstants::LOG_HIT_MINES] = "Vous frappez [mines] mines dans le secteur [sector].";
$l_log_title[LogTypeConstants::LOG_HIT_MINES] = "<font color=yellow>Alerte, mines!</font>";
$l_log_text[LogTypeConstants::LOG_SHIP_DESTROYED_MINES] = "Votre vaisseau a été détruit par un champ de mines dans le secteur [sector]. ";
$l_log_title[LogTypeConstants::LOG_SHIP_DESTROYED_MINES] = "<font color=red>Alerte, mines!</font>";
...
$l_log_title[LogTypeConstants::LOG_PLANET_NOT_DEFEATED] = "Victoire!";
$l_log_title[LogTypeConstants::LOG_RAW] = "Notice";
$l_log_text[LogTypeConstants::LOG_TOLL_RECV] = "Vos intercepteurs dans le secteur [sector] ont collecté une 'taxe' de [toll] crédits.";
$l_log_title[LogTypeConstants::LOG_TOLL_RECV] = "Droits de passage";
$l_log_text[LogTypeConstants::LOG_DEFS_DESTROYED] = "[quantity] [type] ont été détruits dans le secteur [sector].";
$l_log_title[LogTypeConstants::LOG_DEFS_DESTROYED] = "Défenses détruites";
$l_log_text[LogTypeConstants::LOG_PLANET_EJECT] = "Vous avez été éjecté de la planète dans le secteur [sector] parce que [name] à quitté votre alliance.";
$l_log_title[LogTypeConstants::LOG_PLANET_EJECT] = "Éjecté!";
$l_log_text[LogTypeConstants::LOG_BADLOGIN] = "Tentative de connection échouée à partir de [ip].";
$l_log_title[LogTypeConstants::LOG_BADLOGIN] = "Mauvais mot de passe";
$l_log_text[LogTypeConstants::LOG_PLANET_SCAN] = "[name] a sondé votre plànete [planet_name] dans le secteur [sector].";
$l_log_title[LogTypeConstants::LOG_PLANET_SCAN] = "Planète sondée";
$l_log_text[LogTypeConstants::LOG_PLANET_SCAN_FAIL] = "[name] a essayé de sonder votre planète [planet_name] dans le secteur [sector], mais a échoué.";
$l_log_title[LogTypeConstants::LOG_PLANET_SCAN_FAIL] = "Tentative de sonde";
$l_log_text[LogTypeConstants::LOG_SHIP_SCAN] = "[player] a sondé votre vaisseau.";
$l_log_title[LogTypeConstants::LOG_SHIP_SCAN] = "Vaisseau sondé";
$l_log_text[LogTypeConstants::LOG_SHIP_SCAN_FAIL] = "[player] a essayé de sonder votre vaisseau, mais a échoué.";
$l_log_title[LogTypeConstants::LOG_SHIP_SCAN_FAIL] = "Tentative de sonde";
$l_log_text[LogTypeConstants::LOG_Xenobe_ATTACK] = "Attaque sur [player]...";
$l_log_title[LogTypeConstants::LOG_Xenobe_ATTACK] = "Attaque";
$l_log_text[LogTypeConstants::LOG_STARVATION] = "Une de vos planètes dans le secteur [sector] ne peut soutenir sa population! Plus de végétaux sont nécéssaires. [starvation] colons sont morts de faim.";
$l_log_title[LogTypeConstants::LOG_STARVATION] = "<font color=yellow>Famine!</font>";
$l_log_text[LogTypeConstants::LOG_TOW] = "Votre vaisseau a été remorqué du secteur [sector] vers le secteur [newsector] parce que sa coque dépassait la limite persise de [hull].";
$l_log_title[LogTypeConstants::LOG_TOW] = "Remorqué!";
$l_log_text[LogTypeConstants::LOG_DEFS_DESTROYED_F] = "Vous avez détruit [fighters] intercepteurs dans le secteur [sector].";
$l_log_title[LogTypeConstants::LOG_DEFS_DESTROYED_F] = "Intercepteurs détruits";
$l_log_text[LogTypeConstants::LOG_DEFS_KABOOM] = "Votre vaisseau a été détruit par une force d'intercepteurs dans le secteur [sector]. ";
$l_log_title[LogTypeConstants::LOG_DEFS_KABOOM] = "<font color=red>Vaisseau détruit!</font>";
$l_log_text[LogTypeConstants::LOG_HARAKIRI] = "Vous êtes fatigué de commander cette poubelle volante. Vous décidez que l'univers sera un meilleur endroit sans vous. Votre vaisseau et tout son équipage sont vaporisés quand vous activez la commande d'auto-destruction. Authorisé à partir de [ip].";
$l_log_title[LogTypeConstants::LOG_HARAKIRI] = "<font color=red>Auto-destruction!</font>";
$l_log_text[LogTypeConstants::LOG_TEAM_REJECT] = "[player] a rejeté l'invitation pour faire partie de votre alliance [teamname].";
$l_log_title[LogTypeConstants::LOG_TEAM_REJECT] = "Invitation rejetée";
$l_log_text[LogTypeConstants::LOG_TEAM_RENAME] = "Vous avez renommé votre alliance [team].";
$l_log_title[LogTypeConstants::LOG_TEAM_RENAME] = "Alliance renommée";
$l_log_text[LogTypeConstants::LOG_TEAM_M_RENAME] = "Le co-ordinateur de votre alliance a rebaptisé l'alliance [team].";
$l_log_title[LogTypeConstants::LOG_TEAM_M_RENAME] = "Alliance renommée";
$l_log_text[LogTypeConstants::LOG_TEAM_KICK] = "Vous avez été éjecté de l'alliance [team].";
$l_log_title[LogTypeConstants::LOG_TEAM_KICK] = "Éjecté!";
$l_log_text[LogTypeConstants::LOG_TEAM_CREATE] = "Vous avez crée une nouvelle alliance, [team].";
$l_log_title[LogTypeConstants::LOG_TEAM_CREATE] = "Nouvelle alliance créée";
$l_log_text[LogTypeConstants::LOG_TEAM_LEAVE] = "Vous avez quitté l'alliance [team].";
$l_log_title[LogTypeConstants::LOG_TEAM_LEAVE] = "Départ";
$l_log_text[LogTypeConstants::LOG_TEAM_NEWLEAD] = "Vous avez quitté l'alliance [team]. Vous avez passé la direction de l'alliance à [name].";
$l_log_title[LogTypeConstants::LOG_TEAM_NEWLEAD] = "Départ";
$l_log_text[LogTypeConstants::LOG_TEAM_LEAD] = "Le co-ordinateur de votre alliance [team] a décidé de quitter l'alliance. Vous avez été désigné pour prendre sa place.";
$l_log_title[LogTypeConstants::LOG_TEAM_LEAD] = "Promotion!";
$l_log_text[LogTypeConstants::LOG_TEAM_JOIN] = "Vous êtes maintenant member de l'alliance [team].";
$l_log_title[LogTypeConstants::LOG_TEAM_JOIN] = "Nouveau membre";
$l_log_text[LogTypeConstants::LOG_TEAM_NEWMEMBER] = "[name] a accepté de se joindre à [team]. Ceci vous approche un peu plus de la domination totale!";
$l_log_title[LogTypeConstants::LOG_TEAM_NEWMEMBER] = "Nouveau membre";
$l_log_text[LogTypeConstants::LOG_TEAM_INVITE] = "Vous avez été invité pour faire partie de l'alliance [team].";
$l_log_title[LogTypeConstants::LOG_TEAM_INVITE] = "Invitation";
$l_log_text[LogTypeConstants::LOG_TEAM_NOT_LEAVE] = "[player] a quitté votre alliance.";
$l_log_title[LogTypeConstants::LOG_TEAM_NOT_LEAVE] = "Alliance diminuée";
$l_log_text[LogTypeConstants::LOG_ADMIN_HARAKIRI] = "[player] s'est auto-détruit à partir de [ip].";
$l_log_title[LogTypeConstants::LOG_ADMIN_HARAKIRI] = "Auto-destruction";
$l_log_text[LogTypeConstants::LOG_ADMIN_ILLEGVALUE] = "[player] avait [quantity] [type], alors que son maximum possible était [holds]";
$l_log_title[LogTypeConstants::LOG_ADMIN_ILLEGVALUE] = "Valeur illégale";
$l_log_text[LogTypeConstants::LOG_ADMIN_PLANETDEL] = "[attacker] a essayé de capturer la planète de [defender] dans le secteur [sector]. La planète a été détruite.";
$l_log_title[LogTypeConstants::LOG_ADMIN_PLANETDEL] = "Planète détruite";
$l_log_text[LogTypeConstants::LOG_DEFENCE_DEGRADE] = "Les intercepteurs dans le secteur [sector] ce sont dégradés de [degrade] pourcents parce qu'ils n'ont pas assez d'énergie.";
$l_log_test[LogTypeConstants::LOG_DEFENCE_DEGRADE] = "Dégradation";
$l_log_text[LogTypeConstants::LOG_PLANET_CAPTURED] = "Vous avez capturé une planète appartenant à [owner]. Il y avait [cols] colons et [credits] crédits sur celle-ci.";
$l_log_title[LogTypeConstants::LOG_PLANET_CAPTURED] = "Planète capturée!";
...
$l_team_noalliances  = "Il n'y a présentement aucune alliance dans la galaxie.";
...
$l_feedback_info        = "Veuillez envoyer des commentaires en anglais seulement"; // gameadmins put all your languages here
...
$l_login_newp           = "Si vous êtes un nouveau joueur, cliquez <A href=[new]>ici</A>.";
...
$l_login_died           = "Votre vaisseau a été détruit, mais votre module de secours vous a sauvé vous ainsi que votre équipage.  Cliquez <A HREF=[main]>ici</A> pour recommencer avec un nouveau vaisseau.";
...
$l_login_newlife        = "Cliquez <A HREF=[main]>ici</A> pour continuer vers une nouvelle vie.";
...
$l_login_noone          = "Ce joueur n'existe pas! - Créer un nouveau joueur <A href=[new]>ici</A>.";
$l_login_lang = "Langue";
...
$l_new_err          = "S'il vous plaît cliquez <a href=[new]>ici</a> pour réessayer.";
...
$l_mail_noplayer        = "Ce joueur n'existe pas! - Créer un nouveau joueur <a href=[new]>ici</a>.";
...
$l_global_mmenu         = "Cliquez <A HREF=[main]>ici</A> pour retourner au menu principal.";
$l_global_mlogin        = "Cliquez <A HREF=[login]>ici</A> pour retourner à l'écran de connection.";
$l_global_needlogin     = "Vous devez vous connecter, cliquez <A HREF=[login]>ici</A>.";
$l_global_died          = "Vous êtes mort! <a href=[log]>Voici</a> ce qui vous est arrivé<BR><BR>Meilleure chance la prochaine fois!";
...
$l_zname[1] = "Espace non-exploré";
$l_zname[2] = "Espace de la Fédération";
$l_zname[3] = "Espace de libre-commerce";
$l_zname[4] = "Zonne de Guerre";
