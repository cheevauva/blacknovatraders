...
$l_settings_game = 'Game Settings';
$l_settings_game_version = "Game version:";
$l_settings_game_name = "Game name:";
$l_settings_mine_hullsize = "Average tech level needed to hit mines";
$l_settings_ewd_maxhullsize = "Averaged Tech level When Emergency Warp Degrades";
$l_settings_number_of_sectors = "Number of Sectors";
$l_settings_max_links_per_sector = "Maximum Links per sector";
$l_settings_fed_max_hull = "Maximum average tech level for Federation Sectors";
$l_settings_allow_ibank = "Intergalactic Bank Enabled";
$l_settings_yes = "Yes";
$l_settings_no = "No";
$l_settings_igb_interest_rate = "IGB Interest rate per update";
$l_settings_igb_loan_rate = "IGB Loan rate per update";
$l_settings_tech_upgrade_bases = "Tech Level upgrade for Bases";
$l_settings_colonists_limit = "Colonists Limit";
$l_settings_max_accumulated_turns = "Maximum number of accumulated turns";
$l_settings_max_planets_per_sector = "Maximum number of planets per sector";
$l_settings_max_traderoutes_per_player = "Maximum number of traderoutes per player";
$l_settings_colonist_production_rate = "Colonist Production Rate";
$l_settings_energy_per_fighter = "Unit of Energy used per sector fighter";
$l_settings_defence_degrade_rate = "Sector fighter degradation percentage rate";
$l_settings_min_bases_to_own = "Number of planets with bases need for sector ownership";
$l_settings_planet_interest_rate = "Planet interest rate";
$l_settings_colonists_per_fighter = "Colonists needed to produce 1 Fighter each turn";
$l_settings_colonists_per_torpedo = "Colonists needed to produce 1 Torpedo each turn";
$l_settings_colonists_per_ore = "Colonists needed to produce 1 Ore each turn";
$l_settings_colonists_per_organics = "Colonists needed to produce 1 Organics each turn";
$l_settings_colonists_per_goods = "Colonists needed to produce 1 Goods each turn";
$l_settings_colonists_per_energy = "Colonists needed to produce 1 Energy each turn";
$l_settings_colonists_per_credits = "Colonists needed to produce 1 Credits each turn";

$l_settings_game_scheduler = "Game Scheduler Settings";
$l_settings_ticks_happen = "Ticks happen every";
$l_settings_turns_happen = "Turns will happen every";
$l_settings_defenses_checked = "Defenses will be checked every";
$l_settings_xenobes_play = "Xenobes will play every";
$l_settings_igb_interest_accumulated = "Interests on IGB accounts will be accumulated every";
$l_settings_news_generated = "News will be generated every";
$l_settings_planets_production = "Planets will generate production every";
$l_settings_ports_regenerate = "Ports will regenerate every";
$l_settings_ships_towed = "Ships will be towed from fed sectors every";
$l_settings_rankings_generated = "Rankings will be generated every";
$l_settings_sector_defences_degrade = "Sector Defences will degrade every";
$l_settings_planetary_apocalypse = "The planetary apocalypse will occur every";
$l_settings_minutes = "minutes";
