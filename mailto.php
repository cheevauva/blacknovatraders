...
if (empty($content)) {
    $res = $db->adoExecute("SELECT * FROM ships WHERE ship_destroyed = 'N' ORDER BY character_name ASC");
    ...
    $db->adoExecute("INSERT INTO messages (sender_id, recp_id, subject, message) VALUES ('" . $playerinfo[ship_id] . "', '" . $target_info[ship_id] . "', '" . $subject . "', '" . $content . "')");
