...
echo "<body class='igb-body'>";
?>

<style type="text/css">
    input.term, select.term {
...
<center>
        ...
        <tr><td align=center background=images/IGBscreen.gif>
                <table width=520 height=300 border=0>
                    ...
                    if ($command == 'login') { //main menu
                        ...
                        echo "
  <tr><td width=25% valign=bottom><a href=\"main.php\"><span class='igb-text'>$l_igb_quit</a></td><td width=50%>
  <span class='igb-text'>
  <pre>
  ...
  <td width=25% valign=bottom align=right><span class='igb-text'><a href=\"igb.php?command=login\">$l_igb_login</a></td>
  ";
                    }
                    ?>
...
function IGB_login()
{
    ...
    echo "<tr><td colspan=2 align=center valign=top><span class='igb-text'>$l_igb_welcometoigb<br>---------------------------------</td></tr>" .
    "<tr valign=top>" .
    "<td><span class='igb-text'>$l_igb_accountholder :<br><br>$l_igb_shipaccount :<br>$l_igb_igbaccount&nbsp;&nbsp;:</td>" .
    "<td align=right><span class='igb-text'>" . $playerinfo['character_name'] . "&nbsp;&nbsp;<br><br>" . NUMBER($playerinfo['credits']) . " $l_igb_credit_symbol<br>" . NUMBER($account['balance']) . " $l_igb_credit_symbol<br></td>" .
    "</tr>" .
    "<tr><td colspan=2 align=center><span class='igb-text'>$l_igb_operations<br>---------------------------------<br><br><a href=\"igb.php?command=withdraw\">$l_igb_withdraw</a><br><a href=\"igb.php?command=deposit\">$l_igb_deposit</a><br><a href=\"igb.php?command=transfer\">$l_igb_transfer</a><br><a href=\"igb.php?command=loans\">$l_igb_loans</a><br>&nbsp;</td></tr>" .
    "<tr valign=bottom>" .
    "<td><span class='igb-text'><a href=igb.php>$l_igb_back</a></td><td align=right><span class='igb-text'>&nbsp;<br><a href=\"main.php\">$l_igb_logout</a></td>" .
    "</tr>";
}
...
function IGB_withdraw()
{
    ...
    echo "<tr><td colspan=2 align=center valign=top><span class='igb-text'>$l_igb_withdrawfunds<br>---------------------------------</td></tr>" .
    "<tr valign=top>" .
    "<td><span class='igb-text'>$l_igb_fundsavailable :</td>" .
    "<td align=right><span class='igb-text'>" . NUMBER($account['balance']) . " C<br></td>" .
    "</tr><tr valign=top>" .
    "<td><span class='igb-text'>$l_igb_selwithdrawamount :</td><td align=right>" .
    ...
    "</form></td></tr>" .
    "<tr valign=bottom>" .
    "<td><span class='igb-text'><a href=igb.php?command=login>$l_igb_back</a></td><td align=right><span class='igb-text'>&nbsp;<br><a href=\"main.php\">$l_igb_logout</a></td>" .
    "</tr>";
}
...
function IGB_deposit()
{
    ...
    echo "<tr><td colspan=2 align=center valign=top><span class='igb-text'>$l_igb_depositfunds<br>---------------------------------</td></tr>" .
    "<tr valign=top>" .
    "<td><span class='igb-text'>$l_igb_fundsavailable :</td>" .
    "<td align=right><span class='igb-text'>" . NUMBER($playerinfo['credits']) . " C<br></td>" .
    "</tr><tr valign=top>" .
    "<td><span class='igb-text'>$l_igb_seldepositamount :</td><td align=right>" .
...
function IGB_transfer()
{
    ...
    $ships = db()->fetchAll("SELECT character_name, ship_id FROM ships WHERE email not like '%@xenobe' ORDER BY character_name ASC");

    $planets = db()->fetchAll("SELECT name, planet_id, sector_id FROM planets WHERE owner= :ship_id ORDER BY sector_id ASC", [
        'ship_id' => $playerinfo['ship_id']
    ]);

    echo "<tr><td colspan=2 align=center valign=top><span class='igb-text'>$l_igb_transfertype<br>---------------------------------</td></tr>" .
    "<tr valign=top>" .
    "<form action=igb.php?command=transfer2 method=POST>" .
    "<td><span class='igb-text'>$l_igb_toanothership :<br><br>" .
    ...
    "</td></tr>" .
    "<tr valign=top>" .
    "<td><br><span class='igb-text'>$l_igb_fromplanet :<br><br>" .
    "<form action=igb.php?command=transfer2 method=POST>" .
    ...
    echo "<tr valign=top>" .
    "<td><br><span class='igb-text'>$l_igb_conspl :<br><br>" .
...
function IGB_transfer2()
{
    ...
    global $l_igb_errnobase;

    if (isset($ship_id)) { //ship transfer
        $target = db()->fetch("SELECT * FROM ships WHERE ship_id= :ship_id", [
            'ship_id' => $ship_id
        ]);
        ...
        if ($IGB_trate > 0) {
            ...
            $transfer = db()->fetch("SELECT UNIX_TIMESTAMP(time) as time FROM IGB_transfers WHERE UNIX_TIMESTAMP(time) > :curtime AND source_id= :source_id AND dest_id= :dest_id", [
                'curtime' => $curtime,
                'source_id' => $playerinfo['ship_id'],
                'dest_id' => $target['ship_id']
            ]);

            if ($transfer) {
                $difftime = ($transfer['time'] - $curtime) / 60;
        ...
        echo "<tr><td colspan=2 align=center valign=top><span class='igb-text'>$l_igb_shiptransfer<br>---------------------------------</td></tr>" .
        "<tr valign=top><td><span class='igb-text'>$l_igb_igbaccount :</td><td align=right><span class='igb-text'>" . NUMBER($account['balance']) . " C</td></tr>";

        if ($IGB_svalue == 0) {
            echo "<tr valign=top><td><span class='igb-text'>$l_igb_maxtransfer :</td><td align=right><span class='igb-text'>$l_igb_unlimited</td></tr>";
        } else {
            ...
            echo "<tr valign=top><td nowrap><span class='igb-text'>$l_igb_maxtransferpercent :</td><td align=right><span class='igb-text'>" . NUMBER($maxtrans) . " C</td></tr>";
        }

        $percent = $ibank_paymentfee * 100;

        $l_igb_transferrate = str_replace("[igb_num_percent]", NUMBER($percent, 1), $l_igb_transferrate);
        echo "<tr valign=top><td><span class='igb-text'>$l_igb_recipient :</td><td align=right><span class='igb-text'>" . $target['character_name'] . "&nbsp;&nbsp;</td></tr>" .
        "<form action=igb.php?command=transfer3 method=POST>" .
        "<tr valign=top>" .
        "<td><br><span class='igb-text'>$l_igb_seltransferamount :</td>" .
        ...
        "</form>" .
        "<tr><td colspan=2 align=center><span class='igb-text'>" .
        "$l_igb_transferrate" .
        "<tr valign=bottom>" .
        "<td><span class='igb-text'><a href=igb.php?command=transfer>$l_igb_back</a></td><td align=right><span class='igb-text'>&nbsp;<br><a href=\"main.php\">$l_igb_logout</a></td>" .
        "</tr>";
    } else {
        ...
        $source = db()->fetch("SELECT name, credits, owner, sector_id FROM planets WHERE planet_id= :planet_id", [
            'planet_id' => $splanet_id
        ]);
        ...
        $dest = db()->fetch("SELECT name, credits, owner, sector_id, base FROM planets WHERE planet_id= :planet_id", [
            'planet_id' => $dplanet_id
        ]);
        ...
        echo "<tr><td colspan=2 align=center valign=top><span class='igb-text'>$l_igb_planettransfer<br>---------------------------------</td></tr>" .
        "<tr valign=top>" .
        "<td><span class='igb-text'>$l_igb_srcplanet " . $source['name'] . " $l_igb_in " . $source['sector_id'] . " :" .
        "<td align=right><span class='igb-text'>" . NUMBER($source['credits']) . " C" .
        "<tr valign=top>" .
        "<td><span class='igb-text'>$l_igb_destplanet " . $dest['name'] . " $l_igb_in " . $dest['sector_id'] . " :" .
        "<td align=right><span class='igb-text'>" . NUMBER($dest['credits']) . " C" .
        "<form action=igb.php?command=transfer3 method=POST>" .
        "<tr valign=top>" .
        "<td><br><span class='igb-text'>$l_igb_seltransferamount :</td>" .
        "<td align=right><br><input class=term type=text size=15 maxlength=20 name=amount value=0><br>" .
...
function IGB_transfer3()
{
    ...
    if (isset($ship_id)) { //ship transfer
        ...
        echo "<tr><td colspan=2 align=center valign=top><span class='igb-text'>$l_igb_transfersuccessful<br>---------------------------------</td></tr>" .
        "<tr valign=top><td colspan=2 align=center><span class='igb-text'>" . NUMBER($transfer) . " $l_igb_creditsto " . $target['character_name'] . ".</tr>" .
        "<tr valign=top>" .
        "<td><span class='igb-text'>$l_igb_transferamount :</td><td align=right><span class='igb-text'>" . NUMBER($amount) . " C<br>" .
        "<tr valign=top>" .
        "<td><span class='igb-text'>$l_igb_transferfee :</td><td align=right><span class='igb-text'>" . NUMBER($amount2) . " C<br>" .
        "<tr valign=top>" .
        "<td><span class='igb-text'>$l_igb_amounttransferred :</td><td align=right><span class='igb-text'>" . NUMBER($transfer) . " C<br>" .
        "<tr valign=top>" .
        "<td><span class='igb-text'>$l_igb_igbaccount :</td><td align=right><span class='igb-text'>" . NUMBER($account['balance']) . " C<br>" .
        "<tr valign=bottom>" .
        "<td><span class='igb-text'><a href=igb.php?command=login>$l_igb_back</a></td><td align=right><span class='igb-text'>&nbsp;<br><a href=\"main.php\">$l_igb_logout</a></td>" .
        "</tr>";

        db()->q("UPDATE ibank_accounts SET balance=balance- :amount WHERE ship_id= :ship_id", [
            'amount' => $amount,
            'ship_id' => $playerinfo['ship_id']
        ]);

        db()->q("UPDATE ibank_accounts SET balance=balance+ :transfer WHERE ship_id= :ship_id", [
            'transfer' => $transfer,
            'ship_id' => $target['ship_id']
        ]);

        db()->q("INSERT INTO IGB_transfers VALUES(NULL, :source_id, :dest_id, NOW())", [
            'source_id' => $playerinfo['ship_id'],
            'dest_id' => $target['ship_id']
        ]);
    } else {
        ...
        $dest = db()->fetch("SELECT name, credits, owner, sector_id FROM planets WHERE planet_id= :planet_id", [
            'planet_id' => $dplanet_id
        ]);
        ...
        echo "<tr><td colspan=2 align=center valign=top><span class='igb-text'>$l_igb_transfersuccessful<br>---------------------------------</td></tr>" .
        "<tr valign=top><td colspan=2 align=center><span class='igb-text'>" . NUMBER($transfer) . " $l_igb_ctransferredfrom " . $source['name'] . " $l_igb_to " . $dest['name'] . ".</tr>" .
        "<tr valign=top>" .
        "<td><span class='igb-text'>$l_igb_transferamount :</td><td align=right><span class='igb-text'>" . NUMBER($amount) . " C<br>" .
        "<tr valign=top>" .
        "<td><span class='igb-text'>$l_igb_transferfee :</td><td align=right><span class='igb-text'>" . NUMBER($amount2) . " C<br>" .
        ...
        "<td><span class='igb-text'>$l_igb_amounttransferred :</td><td align=right><span class='igb-text'>" . NUMBER($transfer) . " C<br>" .
        "<tr valign=top>" .
        "<td><span class='igb-text'>$l_igb_srcplanet " . $source['name'] . " $l_igb_in " . $source['sector_id'] . " :</td><td align=right><span class='igb-text'>" . NUMBER($source['credits']) . " C<br>" .
        "<tr valign=top>" .
        "<td><span class='igb-text'>$l_igb_destplanet " . $dest['name'] . " $l_igb_in " . $dest['sector_id'] . " :</td><td align=right><span class='igb-text'>" . NUMBER($dest['credits']) . " C<br>" .
        "<tr valign=bottom>" .
        "<td><span class='igb-text'><a href=igb.php?command=login>$l_igb_back</a></td><td align=right><span class='igb-text'>&nbsp;<br><a href=\"main.php\">$l_igb_logout</a></td>" .
        "</tr>";

        db()->q("UPDATE planets SET credits=credits- :amount WHERE planet_id= :planet_id", [
            'amount' => $amount,
            'planet_id' => $splanet_id
        ]);

        db()->q("UPDATE planets SET credits=credits+ :transfer WHERE planet_id= :planet_id", [
            'transfer' => $transfer,
            'planet_id' => $dplanet_id
        ]);
    }
...
function IGB_deposit2()
{
    ...
    echo "<tr><td colspan=2 align=center valign=top><span class='igb-text'>$l_igb_operationsuccessful<br>---------------------------------</td></tr>" .
    "<tr valign=top>" .
    "<td colspan=2 align=center><span class='igb-text'>" . NUMBER($amount) . " $l_igb_creditstoyou</td>" .
    "<tr><td colspan=2 align=center><span class='igb-text'>$l_igb_accounts<br>---------------------------------</td></tr>" .
    "<tr valign=top>" .
    "<td><span class='igb-text'>$l_igb_shipaccount :<br>$l_igb_igbaccount :</td>" .
    "<td align=right><span class='igb-text'>" . NUMBER($playerinfo['credits']) . " C<br>" . NUMBER($account['balance']) . " C</tr>" .
    "<tr valign=bottom>" .
    "<td><span class='igb-text'><a href=igb.php?command=login>$l_igb_back</a></td><td align=right><span class='igb-text'>&nbsp;<br><a href=\"main.php\">$l_igb_logout</a></td>" .
    "</tr>";
...
function IGB_withdraw2()
{
    ...
    echo "<tr><td colspan=2 align=center valign=top><span class='igb-text'>$l_igb_operationsuccessful<br>---------------------------------</td></tr>" .
    "<tr valign=top>" .
    "<td colspan=2 align=center><span class='igb-text'>" . NUMBER($amount) . " $l_igb_creditstoyourship</td>" .
    "<tr><td colspan=2 align=center><span class='igb-text'>$l_igb_accounts<br>---------------------------------</td></tr>" .
    "<tr valign=top>" .
    "<td><span class='igb-text'>Ship Account :<br>$l_igb_igbaccount :</td>" .
    "<td align=right><span class='igb-text'>" . NUMBER($playerinfo['credits']) . " C<br>" . NUMBER($account['balance']) . " C</tr>" .
    "<tr valign=bottom>" .
    "<td><span class='igb-text'><a href=igb.php?command=login>$l_igb_back</a></td><td align=right><span class='igb-text'>&nbsp;<br><a href=\"main.php\">$l_igb_logout</a></td>" .
    "</tr>";
...
function IGB_loans()
{
    ...
    echo "<tr><td colspan=2 align=center valign=top><span class='igb-text'>$l_igb_loanstatus<br>---------------------------------</td></tr>" .
    "<tr valign=top><td><span class='igb-text'>$l_igb_shipaccount :</td><td align=right><span class='igb-text'>" . NUMBER($playerinfo['credits']) . " C</td></tr>" .
    "<tr valign=top><td><span class='igb-text'>$l_igb_currentloan :</td><td align=right><span class='igb-text'>" . NUMBER($account['loan']) . " C</td></tr>";

    if ($account['loan'] != 0) {
        $curtime = time();
        $time = db()->fetch("SELECT UNIX_TIMESTAMP(loantime) as time FROM ibank_accounts WHERE ship_id= :ship_id", [
            'ship_id' => $playerinfo['ship_id']
        ]);

        $difftime = ($curtime - $time['time']) / 60;

        echo "<tr valign=top><td nowrap><span class='igb-text'>$l_igb_loantimeleft :</td>";

        if ($difftime > $IGB_lrate) {
            echo "<td align=right><span class='igb-text'>$l_igb_loanlate</td></tr>";
        } else {
            $difftime = $IGB_lrate - $difftime;
            $hours = (int) ($difftime / 60);
            $mins = $difftime % 60;
            echo "<td align=right><span class='igb-text'>${hours}h ${mins}m</td></tr>";
        }
        ...
        "<tr valign=top>" .
        "<td><br><span class='igb-text'>$l_igb_repayamount :</td>" .
        "<td align=right><br><input class=term type=text size=15 maxlength=20 name=amount value=0><br>" .
        ...
        echo "<tr valign=top><td nowrap><span class='igb-text'>$l_igb_maxloanpercent :</td><td align=right><span class='igb-text'>" . NUMBER($maxloan) . " C</td></tr>";
        ...
        "<tr valign=top>" .
        "<td><br><span class='igb-text'>$l_igb_loanamount :</td>" .
        "<td align=right><br><input class=term type=text size=15 maxlength=20 name=amount value=0><br>" .
...
function IGB_borrow()
{
    ...
    $hours = (int) ($IGB_lrate / 60);
    $mins = $IGB_lrate % 60;

    $l_igb_loanreminder = str_replace("[hours]", $hours, $l_igb_loanreminder);
    $l_igb_loanreminder = str_replace("[mins]", $mins, $l_igb_loanreminder);

    echo "<tr><td colspan=2 align=center valign=top><span class='igb-text'>$l_igb_takenaloan<br>---------------------------------</td></tr>" .
    "<tr valign=top><td colspan=2 align=center><span class='igb-text'>$l_igb_loancongrats<br><br></tr>" .
    "<tr valign=top>" .
    "<td><span class='igb-text'>$l_igb_loantransferred :</td><td nowrap align=right><span class='igb-text'>" . NUMBER($amount) . " C<br>" .
    "<tr valign=top>" .
    "<td><span class='igb-text'>$l_igb_loanfee :</td><td nowrap align=right><span class='igb-text'>" . NUMBER($amount2) . " C<br>" .
    "<tr valign=top>" .
    "<td><span class='igb-text'>$l_igb_amountowned :</td><td nowrap align=right><span class='igb-text'>" . NUMBER($amount3) . " C<br>" .
    "<tr valign=top>" .
    "<td colspan=2 align=center><span class='igb-text'>---------------------------------<br><br>$l_igb_loanreminder</td>" .
    "<tr valign=top>" .
    "<td nowrap><span class='igb-text'><a href=igb.php?command=login>$l_igb_back</a></td><td nowrap align=right><span class='igb-text'>&nbsp;<a href=\"main.php\">$l_igb_logout</a></td>" .
    "</tr>";

    db()->q("UPDATE ibank_accounts SET loan= :loan, loantime=NOW() WHERE ship_id= :ship_id", [
        'loan' => $amount3,
        'ship_id' => $playerinfo['ship_id']
    ]);
...
function IGB_repay()
{
    ...
    echo "<tr><td colspan=2 align=center valign=top><span class='igb-text'>$l_igb_payloan<br>---------------------------------</td></tr>" .
    "<tr valign=top>" .
    "<td colspan=2 align=center><span class='igb-text'>$l_igb_loanthanks</td>" .
    "<tr valign=top>" .
    "<td colspan=2 align=center><span class='igb-text'>---------------------------------</td>" .
    "<tr valign=top>" .
    "<td><span class='igb-text'>$l_igb_shipaccount :</td><td nowrap align=right><span class='igb-text'>" . NUMBER($playerinfo['credits']) . " C<br>" .
    "<tr valign=top>" .
    "<td><span class='igb-text'>$l_igb_payloan :</td><td nowrap align=right><span class='igb-text'>" . NUMBER($amount) . " C<br>" .
    "<tr valign=top>" .
    "<td><span class='igb-text'>$l_igb_currentloan :</td><td nowrap align=right><span class='igb-text'>" . NUMBER($account['loan']) . " C<br>" .
    "<tr valign=top>" .
    "<td colspan=2 align=center><span class='igb-text'>---------------------------------</td>" .
    "<tr valign=top>" .
    "<td nowrap><span class='igb-text'><a href=igb.php?command=login>$l_igb_back</a></td><td nowrap align=right><span class='igb-text'>&nbsp;<a href=\"main.php\">$l_igb_logout</a></td>" .
    ...
    db()->q("UPDATE ibank_accounts SET loan=loan- :amount, loantime= :loantime WHERE ship_id= :ship_id", [
        'amount' => $amount,
...
function IGB_consolidate()
{
    ...
    global $l_igb_unnamed, $l_igb_currentpl, $l_igb_consolrates;
    ...
    echo "<tr><td colspan=2 align=center valign=top><span class='igb-text'>$l_igb_planetconsolidate<br>---------------------------------</td></tr>" .
    "<form action=igb.php?command=consolidate2 method=POST>" .
    "<tr valign=top>" .
    "<td colspan=2><span class='igb-text'>$l_igb_consolrates :</td>" .
    "<tr valign=top>" .
    "<td><span class='igb-text'>$l_igb_minimum :<br>" .
    "<br>$l_igb_maximum :</td>" .
    "<td align=right><span class='igb-text'>" .
...
function IGB_consolidate2()
{
    ...
    $query = "SELECT SUM(credits) as total, COUNT(*) as count from planets WHERE owner= :owner AND credits != 0";
    $params = ['owner' => $playerinfo['ship_id']];
    ...
    $params['dplanet_id'] = $dplanet_id;

    $amount = db()->fetch($query, $params);
    ...
    echo "<tr><td colspan=2 align=center valign=top><span class='igb-text'>$l_igb_planetconsolidate<br>---------------------------------</td></tr>" .
    "<tr valign=top>" .
    "<td><span class='igb-text'>$l_igb_currentpl " . $dest['name'] . " $l_igb_in " . $dest['sector_id'] . " :</td>" .
    "<td align=right><span class='igb-text'>" . NUMBER($dest['credits']) . " C</td>" .
    "<tr valign=top>" .
    "<td><span class='igb-text'>$l_igb_transferamount :</td>" .
    "<td align=right><span class='igb-text'>" . NUMBER($amount['total']) . " C</td>" .
    "<tr valign=top>" .
    "<td><span class='igb-text'>$l_igb_transferfee :</td>" .
    "<td align=right><span class='igb-text'>" . NUMBER($fee) . " C </td>" .
    "<tr valign=top>" .
    "<td><span class='igb-text'>$l_igb_plaffected :</td>" .
    "<td align=right><span class='igb-text'>" . NUMBER($amount['count']) . "</td>" .
    "<tr valign=top>" .
    "<td><span class='igb-text'>$l_igb_turncost :</td>" .
    "<td align=right><span class='igb-text'>" . NUMBER($tcost) . "</td>" .
    "<tr valign=top>" .
    "<td><span class='igb-text'>$l_igb_amounttransferred :</td>" .
    "<td align=right><span class='igb-text'>" . NUMBER($transfer) . " C</td>" .
...
function IGB_consolidate3()
{
    ...
    global $l_igb_errunknownplanet, $l_igb_errnotyourplanet;
    ...
    echo "<tr><td colspan=2 align=center valign=top><span class='igb-text'>$l_igb_transfersuccessful<br>---------------------------------</td></tr>" .
    "<tr valign=top>" .
    "<td><span class='igb-text'>$l_igb_currentpl " . $dest['name'] . " $l_igb_in " . $dest['sector_id'] . " :<br><br>" .
    "$l_igb_turncost :</td>" .
    "<td align=right><span class='igb-text'>" . NUMBER($cplanet) . " C<br><br>" .
    NUMBER($tcost) . "</td>" .
    "<tr valign=bottom>" .
    "<td><span class='igb-text'><a href=igb.php?command=login>$l_igb_back</a></td><td align=right><span class='igb-text'>&nbsp;<br><a href=\"main.php\">$l_igb_logout</a></td>" .
    "</tr>";

    $updateQuery = "UPDATE planets SET credits=0 WHERE owner= :owner AND credits != 0";
    $updateParams = ['owner' => $playerinfo['ship_id']];

    if ($minimum != 0) {
        $updateQuery .= " AND credits >= :minimum";
        $updateParams['minimum'] = $minimum;
    }

    if ($maximum != 0) {
        $updateQuery .= " AND credits <= :maximum";
        $updateParams['maximum'] = $maximum;
    }

    $updateQuery .= " AND planet_id != :dplanet_id";
    $updateParams['dplanet_id'] = $dplanet_id;

    db()->q($updateQuery, $updateParams);
    db()->q("UPDATE planets SET credits=credits + :transfer WHERE planet_id= :dplanet_id", [
        'transfer' => $transfer,
        'dplanet_id' => $dplanet_id
    ]);
    db()->q("UPDATE ships SET turns=turns - :tcost WHERE ship_id = :ship_id", [
        'tcost' => $tcost,
        'ship_id' => $playerinfo['ship_id']
    ]);
}
...
function IGB_error($errmsg, $backlink, $title = "Error!")
{
    ...
    echo "<tr><td colspan=2 align=center valign=top><span class='igb-text'>$title<br>---------------------------------</td></tr>" .
    "<tr valign=top>" .
    "<td colspan=2 align=center><span class='igb-text'>$errmsg</td>" .
    "</tr>" .
    "<tr valign=bottom>" .
    "<td><span class='igb-text'><a href=$backlink>$l_igb_back</a></td><td align=right><span class='igb-text'>&nbsp;<br><a href=\"main.php\">$l_igb_logout</a></td>" .
    "</tr>" .
    "</table>" .
    "</td></tr>" .
    "</table>" .
