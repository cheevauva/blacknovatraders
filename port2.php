...
if ($playerinfo['turns'] < 1) {
    ...
    if ($sectorinfo['port_type'] == "special") {
        ...
        if ($total_cost > $playerinfo['credits']) {
         ...
         <TR>
            <TD colspan=99><strong>$l_trade_result</strong></TD>
         </TR>
         <TR>
            <TD colspan=99><strong>$l_cost : $trade_credits $l_credits</strong></TD>
         </TR>";
      ...
      <TABLE class=\"table\">
         ...
         <TR>
            <TD colspan=99><strong style=\"color: $trade_color\">" . $trade_result . " " . NUMBER(abs($total_cost)) . " $l_credits</strong></TD>
         </TR>
         <TR>
            <TD><strong>$l_traded_ore: </strong></TD><TD>" . NUMBER($trade_ore) . "</TD>
         </TR>
         <TR>
            <TD><strong>$l_traded_organics: </strong></TD><TD>" . NUMBER($trade_organics) . "</TD>
         </TR>
         <TR>
            <TD><strong>$l_traded_goods: </strong></TD><TD>" . NUMBER($trade_goods) . "</TD>
         </TR>
         <TR>
            <TD><strong>$l_traded_energy: </strong></TD><TD>" . NUMBER($trade_energy) . "</TD>
         </TR>
      </TABLE>
      ";

            /* Update ship cargo, credits and turns */
            db()->q("UPDATE ships SET turns=turns-1, turns_used=turns_used+1, rating=rating+1, credits=credits- :total_cost, ship_ore=ship_ore+ :trade_ore, ship_organics=ship_organics+ :trade_organics, ship_goods=ship_goods+ :trade_goods, ship_energy=ship_energy+ :trade_energy where ship_id= :ship_id", [
