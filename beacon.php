...
if($playerinfo[dev_beacon] > 0)
{
  ...
  elseif($zoneinfo[allow_beacon] == 'L')
  {
    ...
    $result5 = $db->Execute("SELECT team FROM ships WHERE ship_id='$zoneowner_info[owner]'");
  ...
  if($allowed_rsw == "Y")
  {
    ...
    else
    {
      ...
      $update = $db->Execute("UPDATE ships SET dev_beacon=dev_beacon-1 WHERE ship_id=$playerinfo[ship_id]");
    }
